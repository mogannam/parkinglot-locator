...
%                                                revised:  2000 Jan 27.
%
% M-file to calculate a "MODEL-1" least squares fit to WEIGHTED x,y-datapairs:
%
...
%       Sciences, 2nd Ed."
%       for mw, bw, smw and sbw, see p. 98, example calculation in Table
%       for mw, bw, smw and sbw, see p. 98, example calculation in
%       Table 6.2;
%       for rw, see p. 199, and modify eqn 11.17 for a weighted
%       regression by
...
%     NOTE that the line passes through the weighted centroid: (xw,yw).
                                                                               function [mw,bw,rw,smw,sbw,xw,yw]=fitregression(X,Y,W)
